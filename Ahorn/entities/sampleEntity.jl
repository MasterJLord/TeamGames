module practiceModSampleEntity

using ..Ahorn, Maple

@mapdef Entity "practiceMod/SampleEntity" SampleEntity(
    x::Integer, y::Integer,
    sampleProperty::Integer=0
)

const placements = Ahorn.PlacementDict(
    "Sample Entity (practiceMod)" => Ahorn.EntityPlacement(
        SampleEntity,
    )
)

sprite = "objects/practiceMod/sampleEntity/idle00"
